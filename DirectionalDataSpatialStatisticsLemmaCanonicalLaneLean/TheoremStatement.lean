import HautevilleHouse.DirectionalDataSpatialStatisticsLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "Directional data spatial statistics lemma: sufficiency, exponential families, Neyman-Pearson lemma, MLE consistency",
